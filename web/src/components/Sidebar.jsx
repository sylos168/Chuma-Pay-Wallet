...
import {
  ...
  Terminal, Signal, Settings, Zap, X, User, Bitcoin,
} from 'lucide-react'

const NAV_ITEMS = [
  { to: '/',         icon: Wallet,      label: 'Dashboard'      },
  { to: '/transact', icon: ArrowUpDown, label: 'Send & Receive' },
  { to: '/bitcoin',  icon: Bitcoin,     label: 'Bitcoin Wallet' },
    ...
    <>
      ...
      `}>
        <div className="p-6 flex items-center justify-between">
          ...
          <button onClick={onClose} className="lg:hidden p-2 rounded-md hover:bg-secondary text-muted-foreground">
            <X className="w-4 h-4" />
          </button>
        </div>
